...
const StyledSidebar = styled.aside<StyledSidebarProps>`
    ...
    @media (max-width: 768px) {
        ...
        box-shadow: -10px 0px 30px -15px ${BLUE_DARK_80};
        z-index: 9;
...
//   };
    ...
    // const wrapperRef: React.MutableRefObject<HTMLDivElement> = useRef(document.createElement('div'));
            ...
            <div>
                ...
                <StyledSidebar menuOpen={menuOpen} aria-hidden={!menuOpen} tabIndex={menuOpen ? 1 : -1}>
                    <nav ref={navRef}>
                        {navOptions && (
                            <ol>
                                {navOptions.map(({ url, name }: NavOption, i: number) => (
                                    <li key={i}>
